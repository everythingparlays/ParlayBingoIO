...
const App_redirect = lazy(() => import('pages/app_redirect/App_redirect'))
      ...
      <ThemeProvider>
        ...
        >
          <Routes>
            ...
            <Route path="/app_redirect" element={<App_redirect />} />
            {/* Legacy route for backward compatibility */}
            <Route path="/app_redirect/:type/:code" element={<App_redirect />} />
          </Routes>
        </Suspense>
      </ThemeProvider>
    </HelmetProvider>
