...
const SingleContestRedirectPage = lazy(() => import('pages/ContestRedirects/SingleContestRedirect'))
...
const DailyFantasySportsRoute = lazy(() => import('pages/SEORoutes/DailyFantasySportsRoute'))
